...
cmd_init() {
  ...
  echo "  - Guest kernel: PREEMPT_RT parameters without guest CPU isolation"
  echo "  - XML: CPU pinning, IOThreads, memory locking, PMU/balloon disable, clock tuning"
  echo "  - Host tuning: applied at start; persistent boot isolation remains manual"
  echo ""
  echo "Next steps:"
